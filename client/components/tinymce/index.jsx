	...
	componentDidMount: function() {
		...
		tinymce.init( {
			...
			toolbar1: config.isEnabled( 'post-editor/insert-menu' )
				...
				: 'wpcom_add_media,formatselect,bold,italic,bullist,numlist,link,blockquote,alignleft,aligncenter,alignright,spellchecker,wp_more,wpcom_insert_menu,wpcom_advanced',
